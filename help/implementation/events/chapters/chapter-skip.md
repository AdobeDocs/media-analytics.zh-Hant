...
使用`MEDIA_CHAPTER_SKIP`事件型別呼叫`mediaTrackEvent`：
...
傳送`chapterSkip`張貼至[事件端點](https://developer.adobe.com/analytics-collection-apis/methods/media-collection/events)：
