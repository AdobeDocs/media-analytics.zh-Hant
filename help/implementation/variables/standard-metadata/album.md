...
| **XDM集合欄位** | [`xdm.mediaCollection.sessionDetails.album`](https://experienceleague.adobe.com/en/docs/experience-platform/xdm/data-types/session-details-collection) |
...
在呼叫`mediaTrackSessionStart`之前，使用`MEDIA_AudioMetadataKeyALBUM`在媒體物件的標準中繼資料中設定相簿：
