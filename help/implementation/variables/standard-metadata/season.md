...
| **XDM集合欄位** | [`mediaCollection.sessionDetails.season`](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/xdm/data-types/session-details-collection) |
