...
| --- | --- |
| **內容資料變數** | `a.media.type` |
| **XDM集合欄位** | [`mediaCollection.sessionDetails.showType`](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/xdm/data-types/session-details-collection) |
| **必要** | 否 |
