...
| **XDM集合欄位** | [`mediaCollection.chapterDetails.friendlyName`](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/xdm/data-types/chapter-details-collection) |
| **必要** | 否 |
| **與**&#x200B;一起傳送 | 章節開始、章節關閉 |
