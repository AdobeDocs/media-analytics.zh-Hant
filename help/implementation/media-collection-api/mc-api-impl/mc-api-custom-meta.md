...
如需使用Experience Edge的XDM型實作，請參閱[自訂中繼資料支援 — XDM格式](/help/implementation/edge/implementation-edge-custom-metadata.md)。
...
- [自訂中繼資料支援 — XDM格式](/help/implementation/edge/implementation-edge-custom-metadata.md) — 透過Experience Edge傳送自訂中繼資料給Analytics和AEP
