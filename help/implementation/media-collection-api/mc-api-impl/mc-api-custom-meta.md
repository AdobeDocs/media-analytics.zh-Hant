...
* 避免在自訂中繼資料金鑰中使用`media.`首碼。 此變數對應至標準媒體欄位，並可能在Analytics報表中覆寫這些欄位
...
>[!MORELIKETHIS]
>* [自訂中繼資料支援 — XDM格式](/help/implementation/edge/custom-metadata.md)
>* 報告套裝資料的[Adobe Analytics來源聯結器](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/sources/connectors/adobe-applications/analytics)
