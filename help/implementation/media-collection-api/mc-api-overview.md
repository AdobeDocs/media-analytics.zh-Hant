...
Media Collection API 本質上是轉接程式，可做為伺服器端的 Media SDK。 收集的串流媒體追蹤資料會產生相同的[報表和分析](/help/reporting/media-reports-enable.md)。
...
如需每個SDK實作範例的事件型別完整清單，請參閱[事件概觀](/help/implementation/events/overview.md)。
