...
自訂視訊追蹤採用 Analytics `appMeasurement` 中的[使用自訂連結程式碼手動追蹤連結](https://docs.adobe.com/content/help/zh-Hant/media-analytics/using/measurement-options/cl-in-aa/cl-impl-guide.html)。自訂視訊連結視訊追蹤經常用於不太需要視訊測量的平台與裝置上。
