...
如需管理員的新功能、修正和重要資訊的相關資訊，請參閱下列資源。
...
## Adobe Customer Journey Analytics for Streaming Media的新增和更新功能 {#cja-features}
...
## Adobe Analytics for Streaming Media的新增和更新功能 {#sm-features}

| 功能 | 說明 | 目標日期 |
| ----------- | ---------- | ------- |
| 多播放器狀態追蹤 | 使用媒體收集API來實作多個播放器狀態追蹤。 [了解更多](https://experienceleague.adobe.com/docs/media-analytics/using/player-state-tracking/multiple-player-states.html) | 2022 年 9 月 |
| 重新命名XDM欄位 | 為一致性重新命名XDM欄位名稱：<br>*音訊和視訊參數<br>*廣告參數<br>*章節參數<br>*播放器狀態參數<br>*品質參數 | 2022 年 9 月 |
| Device Co-op參考 | 移除對Adobe Experience Cloud Device Co-op和Experience CloudID服務需求的參考。 | 2022 年 8 月 |
| 更新收集和報告的欄位名稱和XDM路徑 | 更新下列項目：<br>*音訊和視訊參數<br>*廣告參數<br>*章節參數<br>*播放器狀態參數<br>*品質參數 | 2022 年 8 月 |
...
| 媒體播放時間面板 | 了解媒體播放時間花費面板如何透過一天中所選粒度期間的觀看時間，來讓媒體用戶了解他們的觀看量。<br>[媒體播放逗留時間面板（教學課程）](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/media-analytics/measuring-media-analytics/media-playback-time-spent-panel.html?lang=zh-Hant) | 2022 年 1 月 |
...
| 功能 | 說明 | 定位或更新日期 |
| ----------- | ---------- | -------------- |
| 媒體播放時間 | Adobe 串流媒體播放時間提供寶貴的觀眾參與度深入分析，並可讓媒體組織透過進階花費時間分析及時段功能，以每分鐘的使用者參與度取得更深入、更細微的分析。您可以觀察在特定時間點觀看您的媒體串流所花費的時間多寡。您可以依不同的資料粒度 (包括新的 5 分鐘、15 分鐘和 30 分鐘資料粒度) 分割播放持續時間。 [了解更多...](/help/media-reports/media-workspace-panels/media-playback-time-spent.md) | 2021 年 9 月 |
| Analytics工作區中的「媒體同時檢閱者」面板 | 了解高峰期同時觀看或使用者數下降的位置。 取得內容品質和檢閱者參與的寶貴見解，並取得疑難排解或規劃數量和規模的協助。 [更多詳情……](/help/media-reports/media-workspace-panels/media-concurrent-viewers.md) <br><br>[Analytics Workspace中的「媒體同時檢閱者」面板（教學課程）](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/using-panels/media-concurrent-viewers-panel-in-analysis-workspace.html?lang=zh-Hant#analysis-workspace) | 2020年9月 <br><br><br>2021年1月 |
