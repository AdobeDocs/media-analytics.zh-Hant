...
我們於2021年8月31日停止支援第4版Mobile SDK後，Adobe也停止支援Media Analytics Mobile SDK for iOS和Android。 (這不包括仍受支援的適用於Web (JS)和OTT平台，例如Chromecast和Roku。)
...
1. **Roku 和 Chromecast SDK 支援是否會受到影響？**
   ...
   否。  目前我們仍將Roku和Chromecast SDK視為獨立式SDK，並繼續提供支援&#x200B;。
&#x200B;
1. **此變更是否會影響 Media Analytics JS SDK 實作？**

   否。  使用Media Analytics JS SDK的客戶可以繼續使用SDK，或透過Adobe Launch啟用它。
&#x200B;
1. **移轉至 Media Analytics 擴充功能的工作量為何？**
   ...
   [Media Analytics擴充功能：新實作](https://developer.adobe.com/client-sdks/documentation/adobe-media-analytics/)
