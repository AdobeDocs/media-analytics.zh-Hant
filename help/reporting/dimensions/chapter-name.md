...
為報表套裝啟用&#x200B;**[[!UICONTROL 媒體章節]](/help/reporting/media-reports-enable.md)**&#x200B;時，Adobe會自動建立章節名稱分類結構。 您負責使用[分類設定](https://experienceleague.adobe.com/en/docs/analytics/components/classifications/sets/overview.html)填入及維護分類。
