...
媒體播放時間有助於分析一段時間內的播放，提供尖峰同時觀看人數的詳細資訊，並具備分解和比較的能力。 若要存取「媒體播放時間」面板，可瀏覽至已啟用串流媒體元件的報表套裝。 然後，按一下最左側的面板圖示，並將面板拖曳到您的Analysis Workspace專案中。[深入瞭解……](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/media-playback-timespent/media-playback-time-spent.html?lang=zh-Hant)
