...
收到[章節完成](/help/implementation/events/chapters/chapter-complete.md)事件時，媒體後端會設定`mediaReporting.chapterDetails.isCompleted = true`。 量度會在章節關閉呼叫上報告。 在播放中跳過或放棄的章節不計為完成。
