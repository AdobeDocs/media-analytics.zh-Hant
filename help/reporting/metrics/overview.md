...
>[!MORELIKETHIS]
>
>* [維度總覽](../dimensions/overview.md)：串流媒體維度參考
>* [計算量度](/help/reporting/calculated-metrics.md)：根據上述基本量度建置的比率和衍生量度
>* [引數對應](/help/implementation/parameters-mapping.md)：完成事件到欄到XDM的參考
>* [事件總覽](/help/implementation/events/overview.md)：推動量度計算的播放器事件
