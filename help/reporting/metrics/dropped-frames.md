...
*此頁面涵蓋&#x200B;**掉格**&#x200B;量度。 Adobe Analytics會從相同的`a.media.qoe.droppedFrameCount`內容資料變數自動填入配對的[掉格（維度）](/help/reporting/dimensions/dropped-frames.md)。 Customer Journey Analytics公開單一`mediaReporting.qoeDataDetails.droppedFrames`欄位，您可將其作為維度或量度使用。 如需如何收集此變數，請參閱[掉格](/help/implementation/variables/quality/dropped-frames.md)。*
