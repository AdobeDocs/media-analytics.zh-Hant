...
| 計算量度 | 說明 | 公式 |
| --- | --- | --- |
| 平均 每個媒體資料流的廣告 | 每個[[!UICONTROL 媒體開始的[[!UICONTROL 廣告開始次數]](/help/reporting/metrics/ad-starts.md)]](/help/reporting/metrics/media-starts.md) | `[Ad starts] / [Media starts]` |
...
| 平均 媒體逗留時間 | 每[[!UICONTROL 個媒體開始的[[!UICONTROL 媒體逗留時間]](/help/reporting/metrics/media-time-spent.md)]](/help/reporting/metrics/media-starts.md) (`HH:MM:SS`) | `[Media time spent] / [Media starts]` |
...
| 平均 廣告逗留時間 | 每[[!UICONTROL 個廣告開始的[[!UICONTROL 廣告逗留時間]](/help/reporting/metrics/ad-time-spent.md) ]](/help/reporting/metrics/ad-starts.md) (`HH:MM:SS`) | `[Ad time spent] / [Ad starts]` |
| 平均 章節逗留時間 | 每個[[!UICONTROL 章節開始的[[!UICONTROL 章節逗留時間]](/help/reporting/metrics/chapter-time-spent.md) (`HH:MM:SS`)]](/help/reporting/metrics/chapter-starts.md) | `[Chapter time spent] / [Chapter starts]` |
...
| 內容暫停期間率 | 總暫停期間]](/help/reporting/metrics/total-pause-duration.md)與[[!UICONTROL 內容逗留時間]](/help/reporting/metrics/content-time-spent.md)的[[!UICONTROL 比率 | `[Total pause duration] / [Content time spent]` |
