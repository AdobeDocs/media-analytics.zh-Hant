---
title: 設定 Roku
description: 適用於 Roku 實施的 Media SDK 應用程式設定。
...
1. 設定 Experience Cloud 訪客 ID。
   ...
   **Experience Cloud 訪客 ID 服務方法**
   ...
   | `setAdvertisingIdentifier` | 用來在 SDK 上設定適用於廣告的 Roku ID (RIDA)例如︰<br/><br/> `ADBMobile().setAdvertisingIdentifier(`<br/>  `"<sample_roku_identifier_for_advertising>")` <br/><br/><br/>使用Roku SDK [getRIDA()](https://developer.roku.com/docs/references/brightscript/interfaces/ifdeviceinfo.md#getrida-as-dynamic) API取得Roku ID for Advertising(RIDA)。 |
