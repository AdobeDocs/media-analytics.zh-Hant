...
如需詳細資訊，請參閱[使用 JavaScript 實作分析](https://docs.adobe.com/content/help/zh-Hant/analytics/implementation/js/overview.html)和[實作 Experience Cloud Identity Service。](https://docs.adobe.com/content/help/zh-Hant/id-service/using/implementation/setup-analytics.html)
