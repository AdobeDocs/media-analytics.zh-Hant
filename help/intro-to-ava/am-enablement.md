...
有了 AAM，您不必再侷限於資料賣方、交換或需求端平台。此外，AAM 也無從得知合作夥伴的資料資產。AAM 提供存取多種資料來源的功能，數位發行者將能使用多樣化的第三方資料和我們的私人資料協作。若要進一步瞭解AAM，請參閱AAM檔案 [Audience manager產品檔案。](https://docs-author.corp.adobe.com/content/help/en/audience-manager/user-guide/aam-home.html)
...
>[!IMPORTANT]
>
>為確保資料順利傳輸至AAM，您應使用最新版Media SDK程式庫。
