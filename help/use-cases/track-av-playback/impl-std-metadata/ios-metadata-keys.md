...
[iOS API參考](https://adobe-marketing-cloud.github.io/media-sdks/reference/ios/)
...
| `ADBVideoMetadataKeySTREAM_FORMAT` | 串流格式 | 影片 |
...
| `ADBAdMetadataKeyCAMPAIGN_ID` | 行銷活動ID | 廣告 |
| `ADBAdMetadataKeyCREATIVE_ID` | Creative Id | 廣告 |
| `ADBAdMetadataKeyPLACEMENT_ID` | 位置ID | 廣告 |
| `ADBAdMetadataKeySITE_ID` | 網站ID | 廣告 |
| `ADBAdMetadataKeyCREATIVE_URL` | Creative Url | 廣告 |
